...
KERNEL="${LUNA_TEST_KERNEL:-${REPO_ROOT}/dist/kernel-alpha-p0/7.2.4/bzImage}"
DESKTOP_ROOT="${LUNA_DESKTOP_ROOT:-${REPO_ROOT}/dist/desktop-root-alpha}"
...
[ -x "$DESKTOP_ROOT/usr/bin/niri-session" ] || { echo "missing niri-session" >&2; exit 1; }

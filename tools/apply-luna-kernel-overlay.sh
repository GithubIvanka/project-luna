...
if line not in text:
    # Keep this independent of the upstream x86 object ordering. Kbuild
    # accepts obj-* assignments anywhere in the directory Makefile, and the
    # Luna object has no initcall ordering dependency.

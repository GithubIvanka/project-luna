...
impl BootMenu {
    ...
    fn selection_for(entry: MenuEntry, default_target: usize) -> BootSelection {
        match entry {
            MenuEntry::Continue => BootSelection { action: BootMenuAction::Continue, target_index: default_target },
            MenuEntry::VerboseBoot => BootSelection { action: BootMenuAction::VerboseBoot, target_index: default_target },
            MenuEntry::SystemImage(index) => BootSelection { action: BootMenuAction::SystemImage, target_index: index },
